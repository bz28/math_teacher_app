 ...
 * this layer is pure chrome. The "Previewing as student" banner now
 * lives at the AppLayout level so it renders for previewing teachers
 * on every route, not just inside the school-student shell.
 */
