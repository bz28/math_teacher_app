 ...
 */
export function TeacherUsagePill() {
  ...
  return (
    <Link
      ...
      className={`mx-3 mb-2 flex items-center justify-between gap-2 rounded-[--radius-sm] border px-3 py-2 text-xs font-semibold transition-colors ${
        hit
