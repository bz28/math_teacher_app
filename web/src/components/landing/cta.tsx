...
export function CTA() {
  ...
  return (
    <section ref={ref} className="bg-gradient-to-b from-transparent via-primary-bg/30 to-transparent px-6 py-24 md:py-32">
      <motion.div
      ...
      >
        ...
        <p className="mt-3 text-lg text-text-secondary">
          Join students who are mastering problems step by step. Free to start.
        </p>
