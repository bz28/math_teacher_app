    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
          ...
          <span style={{ color: "#A29BFE", fontSize: 24, fontWeight: 600, letterSpacing: 1.5 }}>VERADIC AI</span>
        </div>
        <div style={{ display: "flex", flexDirection: "column", flex: 1, justifyContent: "center", gap: 24 }}>
          ...
          <div style={{ fontSize: 28, color: "#9B95C5", lineHeight: 1.5, maxWidth: 700 }}>
            Step-by-step solutions for algebra, calculus, geometry, word problems, and more.
          </div>
        </div>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <span style={{ color: "#6C5CE7", fontSize: 20, fontWeight: 600 }}>veradicai.com/subjects/math</span>
          <div style={{ display: "flex", gap: 12 }}>
            {["Algebra", "Calculus", "Geometry", "Word Problems"].map((tag) => (
              <div key={tag} style={{ background: "rgba(108,92,231,0.15)", border: "1px solid rgba(108,92,231,0.3)", borderRadius: 100, padding: "8px 20px", color: "#A29BFE", fontSize: 15, fontWeight: 500 }}>
                {tag}
              </div>
            ))}
          </div>
