...
const sections = [
  ...
  },
  {
    ...
    content: `
      ...
      <ul>
        ...
        <li>Submit personally identifiable information about other individuals (students, employees, parents) beyond what is necessary to use the Service</li>
        <li>Submit photographs of identifiable people, school buildings or facilities, or recordings of school activities</li>
        ...
        <li>Share your account credentials with any other person, or use another person's account</li>
      ...
      <p><strong>School device and screen-time policies.</strong> When using Veradic on school-issued devices or during school hours, you agree to comply with your school's device-use, screen-time, and "off and away" policies. Veradic is delivered through standard web browsers and supports school-administered access controls; Veradic does not override or bypass district-managed device policies.</p>
    `,
  },
  {
    id: "subscriptions",
  ...
  },
  {
    ...
    content: `
      ...
      <p><strong>Teacher-uploaded materials.</strong> If you are a teacher who uploads curriculum materials, problem sets, or other instructional content to Veradic, you represent that you have the rights necessary to do so under applicable copyright and fair-use principles. Veradic uses teacher-uploaded materials solely to provide the Service to you and your students; we do not redistribute teacher-uploaded materials to other accounts or use them to train AI models.</p>
      <p><strong>AI-generated content.</strong> Content generated by Veradic's AI may contain elements similar to existing copyrighted works. You should treat AI-generated content as a starting point and confirm against authoritative sources before redistributing it. See the AI-Generated Content section below for further detail.</p>
    `,
  },
  {
    id: "ai-content",
...
export default function TermsPage() {
  return <LegalPage title="Terms of Service" lastUpdated="May 24, 2026" sections={sections} />;
}
