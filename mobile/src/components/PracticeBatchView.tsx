              ...
              {choices.map((choice, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* The flex/minWidth wrapper is what makes MathText share
                        row space with the letter circle. MathText's WebView
                        wrapper is width:100%, which alone would compete with
                        the 28px circle and clip wide content (matrices). */}
