...
_SYSTEM = (
    ...
    "independently shippable. ALWAYS include 1-2 small NEW-feature or product-gap "
    "ideas (category 'feature', lower-confidence) IN ADDITION to the defect fixes "
    "— never skip them just because a11y/bug hits are more numerous. Be "
