...
_SYSTEM_PROMPT_TEMPLATE = (
    ...
    "chord between circumference points. For two secants from P, place "
    "the two near points close together on the arc facing P and the two "
    "far points close together on the opposite arc so the secants "
    "converge outside (parallel chords never meet).\n"
