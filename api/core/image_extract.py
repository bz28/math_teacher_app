...
_PROBLEM_PHOTO_EXTRACTION_PROMPT = """Extract all {problems_noun} from this image.
...
def _build_extract_prompt(subject: str) -> str:
    ...
    return _PROBLEM_PHOTO_EXTRACTION_PROMPT.format(problems_noun=cfg["problems_noun"])
